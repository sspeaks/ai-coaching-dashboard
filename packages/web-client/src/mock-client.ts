...
function seedSession(state: SessionState): SessionDetail {
  ...
  const titleByState: Partial<Record<SessionState, string>> = {
    ...
    UPLOADED: "Synthetic demo upload ready",
    TRANSCRIBING: "Synthetic demo listening to recording",
    RECONCILING: "Synthetic demo writing coaching notes",
    TRANSCRIPT_READY: "Synthetic demo writing coaching notes",
    EXTRACTING: "Synthetic demo writing coaching notes",
    AWAITING_REVIEW: "Synthetic demo ready to read",
    COMPLETE: "Synthetic demo ready to read",
    RETRY_PENDING: "Synthetic demo writing coaching notes",
    FAILED: "Synthetic demo needs help",
