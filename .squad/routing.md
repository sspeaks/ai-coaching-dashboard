...
|-----------|----------|----------|
| Architecture and product fit | Morpheus | Build-vs-buy decision, system boundaries, privacy model, interfaces |
| Audio and AI processing | Neo | Ingestion, transcription, diarization, summaries, timestamp evidence |
...
| Work monitoring | Ralph | Backlog, stalled work, follow-up execution |
| RAI review | Rai | Content safety, bias checks, credential detection, ethical review |
| Claim verification | Fact Checker | Product claims, external references, Devil's Advocate analysis |
